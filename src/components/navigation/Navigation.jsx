        ...
        <div className="nav-group">
          <ul>
            ...
            <li
              onClick={(e) => {
                e.preventDefault();
                setCurrentNavigation(navigations.conversations);
              }}
            >
              <Tooltip
                title={<span style={{ fontSize: "14px" }}>Conversations</span>}
                placement="right"
              >
                <a
                  className={
            ...
            >
              <Tooltip
                title={<span style={{ fontSize: "14px" }}>Online Friends</span>}
                placement="right"
              >
                <a
                  className={
            ...
            <li>
              <Tooltip
                title={<span style={{ fontSize: "14px" }}>User Menu</span>}
                placement="right"
              >
                <a
                  href=""
              ...
              >
                {({ TransitionProps, placement }) => (
                  <Grow
                    ...
                    style={{
                      transformOrigin:
                        placement === "top-end" ? "bottom left" : "bottom",
                    }}
                  >
                    <Paper>
