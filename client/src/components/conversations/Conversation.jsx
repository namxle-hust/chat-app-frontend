...
export default function Conversation({
      ...
      const getReceiver = async () => {
        try {
          const res = await axios.get(
            apiRoutes.getUser(conversation.user_id),
            axiosHeadersObject()
          );
  ...
  return (
    <div className="list-group-item">
      <figure
        className={
          isConversationOnline ? "avatar avatar-state-success" : "avatar"
        }
      >
        <img
          src={convImg ? convImg : PF + "person/noAvatar.png"}
      ...
      <div className="users-list-body">
        ...
        <div className="users-list-action">
          ...
          <small className="text-primary">
            {new Date(conversation.message_time).toLocaleString("en-US", {
              hour: "numeric",
              minute: "numeric",
              hour12: true,
              day: "numeric",
